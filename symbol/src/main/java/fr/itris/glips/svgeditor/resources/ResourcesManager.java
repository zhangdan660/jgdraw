...
public class ResourcesManager {
   ...
   static{
	   ...
	   try{
	       bundle=ResourceBundle.getBundle(
	    		"properties.SVGEditorStrings");
	   }catch (Exception ex){ex.printStackTrace();bundle=null;}
   }
  ...
  */
    ...
    {
    	return CommonResourcesManager.getIcon(name, isGrayIcon);
    }
        ...
        if(name!=null && ! name.equals("")){
            ...
            if(cachedXMLDocuments.containsKey(name)){
                ...
                try{
                    ...
                    path=CommonResourcesManager.getPath("xml/"+name);
    ...
    public Document getResourceStore(){
    	...
    	if(resourceStore!=null){
            ...
            try{
            	resourceStore=factory.createDocument(CommonResourcesManager.getPath("xml/visualResourceStore.xml"));
            ...
            if(root!=null){
                ...
                try{
                    writer=new BufferedOutputStream(
                    	new FileOutputStream(new URI(CommonResourcesManager.getPath("xml/"+path)).getPath()));
                }catch (Exception ex){}

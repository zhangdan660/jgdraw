...
public class SVGHandle {
	...
	/**
	 * the object provided methods to handle SymbolStauts changes
	 */
	private SymbolStatusManager symbolStatusManager = new SymbolStatusManager(this);
	...
	public SymbolStatusManager getSymbolStatusManager() {
		return symbolStatusManager;
	}

	public void setSymbolStatusManager(SymbolStatusManager symbolStatusManager) {
		this.symbolStatusManager = symbolStatusManager;
	}
}

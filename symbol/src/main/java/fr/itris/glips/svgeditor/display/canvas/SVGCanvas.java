...
public class SVGCanvas extends JPanel {
	...
	public void setContent(final String content, Monitor monitor){
		try{
			if(monitor!=null){
			...
			//creating the svg document corresponding to this content
	         ...
	         SVGDocument doc =  (SVGDocument) sax.createDocument("",is);

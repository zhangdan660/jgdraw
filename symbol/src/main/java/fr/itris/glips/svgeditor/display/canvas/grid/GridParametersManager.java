...
public class GridParametersManager {
	 ...
	 */
	protected static final double defaultHorizontalDistance=1, defaultVerticalDistance=1;
	 ...
	 * the default stroke
	 */
	protected static final BasicStroke defaultGridStroke=new BasicStroke(
	...
	public GridParametersManager(HandlesManager handlesManager){
		...
		if(Editor.getParent() instanceof Frame){
			...
			gridParametersDialog=
				new GridParametersDialog(this, (Frame)Editor.getParent());
			
		}else if(Editor.getParent() instanceof JDialog){
			
			gridParametersDialog=
				new GridParametersDialog(this, (JDialog)Editor.getParent());
		}
	}
	...
	protected void updatePreferences(){
		...
		PreferencesStore.setPreference(null, 
				GRID_ENABLED_PREF_ID, Boolean.toString(gridEnabled));
		...
		PreferencesStore.setPreference(null, 
				COLOR_PREF_ID, Editor.getColorChooser().getColorString(gridColor));
	 ...
	 * @param gridEnabled whether the grid should be displayed
	 */

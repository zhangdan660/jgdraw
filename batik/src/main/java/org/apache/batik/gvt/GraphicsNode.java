 ...
 * @version $Id: GraphicsNode.java,v 1.1 2005/11/21 09:51:18 dev Exp $
 */
public interface GraphicsNode {
     ...
     * @param newTransform the new transform of this node
     */
    void setSelfTransform(SelfAffineTransform newTransform);
     ...
     */
    SelfAffineTransform getSelfTransform();
    ...
    Rectangle2D getGeometryBounds(AffineTransform aff);

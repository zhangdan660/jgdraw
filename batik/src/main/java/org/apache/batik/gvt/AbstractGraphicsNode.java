 ...
 * @version $Id: AbstractGraphicsNode.java,v 1.1 2005/11/21 09:51:18 dev Exp $
 */
public abstract class AbstractGraphicsNode implements GraphicsNode {
     ...
     * @author zhangdan 
     */
    protected SelfAffineTransform selftransform;
...
//        System.out.println(this.transform +"\t" + this.inverseTransform);
        if (parent != null)
     ...
     */
    public void setSelfTransform(SelfAffineTransform newTransform) {
        fireGraphicsNodeChangeStarted();
        this.selftransform = newTransform;
        this.transform= selftransform.currentTransform;
...
//        System.out.println(this.transform +"\t" + this.inverseTransform);
    ...
    /**
     * returns the transform of this node and initial point
     * @return
     * @author zhangdan
     */
    public SelfAffineTransform getSelfTransform()
    {
    	if(selftransform == null)
    	{
    		selftransform = new SelfAffineTransform(transform,new AffineTransform());
    	}
    	
    	selftransform.currentTransform = transform;
    ...
    public Rectangle2D getGeometryBounds(AffineTransform aff) {
    	return null;
    }
}

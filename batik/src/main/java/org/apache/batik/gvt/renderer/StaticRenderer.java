 ...
 * @version $Id: StaticRenderer.java,v 1.1 2005/11/21 09:51:40 dev Exp $
 */
public class StaticRenderer implements ImageRenderer {
    ...
    public StaticRenderer(RenderingHints rh,
                          AffineTransform at){
        renderingHints = new RenderingHints(new HashMap(rh));
    ...
    public StaticRenderer(){
        renderingHints = new RenderingHints(new HashMap(defaultRenderingHints));

 ...
 * @version $Id: SVGUseElementBridge.java,v 1.1 2005/11/21 09:51:18 dev Exp $
 */
...
//        gn.setTransform(computeTransform(e, ctx));
        ...
        gn.setSelfTransform(computeSelfTransform(e, ctx));
    ...
    /**
     * Computes the AffineTransform for the using node
     */
    protected SelfAffineTransform computeSelfTransform(Element e, BridgeContext ctx) {
        UnitProcessor.Context uctx = UnitProcessor.createContext(ctx, e);
        ...
        SelfAffineTransform sat = new SelfAffineTransform(at,SVGUtilities.convertTransform(e, SVG_TRANSFORM_ATTRIBUTE, s));
        if(s.length() != 0)
        {
        	if(sat.useTransform == null)
        	{
        		sat.useTransform = new AffineTransform();
        	}
        }
        return sat;
     }
    ...
    public void handleDOMAttrModifiedEvent(MutationEvent evt) {
        ...
        if ((evtNode.getNamespaceURI() == null) &&
            ...
            node.setSelfTransform(computeSelfTransform(e, ctx));

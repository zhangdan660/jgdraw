 ...
 * @version $Id: AbstractGraphicsNodeBridge.java,v 1.1 2005/11/21 09:51:18 dev Exp $
 */
public abstract class AbstractGraphicsNodeBridge extends AbstractSVGBridge
    ...
    public GraphicsNode createGraphicsNode(BridgeContext ctx, Element e) {
        ...
        if (s.length() != 0) {
        	SelfAffineTransform saf = new SelfAffineTransform(SVGUtilities.convertTransform(e, SVG_TRANSFORM_ATTRIBUTE, s),new AffineTransform());
            node.setSelfTransform(saf);
        }
        // 'visibility'
    ...
    public void handleDOMAttrModifiedEvent(MutationEvent evt) {
        ...
        if (attrName.equals(SVG_TRANSFORM_ATTRIBUTE)) {
            ...
            node.setSelfTransform(new SelfAffineTransform(at, new AffineTransform()));

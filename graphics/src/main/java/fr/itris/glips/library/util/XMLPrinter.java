...
/**
 * the class providing methods used to convert 
 * documents to XML content and to save it into files
 * @author Jordi SUC
 */
public class XMLPrinter {
     ...
     * @param file the file into which the document will be saved
     * @param monitor the monitor of the progress
     */
    public static void printXML(
    		Document doc, File file, Monitor monitor){
    ...
    /**
     * returns the number of nodes that can be 
     * found in the provided document
     * @param doc the document
     * @return the number of nodes that can be 
     * found in the provided document
     */
     ...
     * @param monitor the monitor for this action
     */
    public static void writeNode(Node node, StringBuffer buffer, 
    		int indent, boolean format, Monitor monitor){
    	
    	if(node!=null){
//    		System.out.println(node.getNodeName());
    		//不保存symbol元素到文件
    		if("symbol".equalsIgnoreCase(node.getNodeName())||

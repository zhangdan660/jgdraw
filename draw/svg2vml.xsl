...
<script src="../../plugin/sea.js"></script>
<script type="text/javascript">
	seajs.use(['../../html/realtime/map/vml','app','base'],function(a,b,$){
		$(a.init);
	})
</script>	
...
<xsl:template match="svg:ref">
<metadata>
	<ref>
	    <xsl:attribute name="primary_meas_text">
	        <xsl:value-of select="@primary_meas_text" />
	    </xsl:attribute>
	    <xsl:attribute name="secondary_meas_text">
	        <xsl:value-of select="@secondary_meas_text" />
	    </xsl:attribute>	    
	    <xsl:attribute name="primary_meas">
	        <xsl:value-of select="@primary_meas" />
	    </xsl:attribute>	    
	    <xsl:attribute name="secondary_meas">
	        <xsl:value-of select="@secondary_meas" />
	    </xsl:attribute>	    
	    <xsl:attribute name="psr_id">
	        <xsl:value-of select="@psr_id" />
	    </xsl:attribute>	    	    	    
	</ref>
</metadata>
</xsl:template>

...
public class ListenerActionBuilder {
    ...
    public static Action createAction(SVGPicture picture, String projectName, JComponent component, 
    	...
    	if(component!=null && actionElement!=null) {
    		...
    		if(nodeName.equals("simpleSendCommand")) {
    		...
    		}else if(nodeName.equals("sendCommand")) {
    		...
    		}else if(nodeName.equals("sendMeasure")) {
    		...
    		}else if(nodeName.equals("loadView")) {
    		...
    		}else if(nodeName.equals("runApplication")) {
    		...
    		}else if(nodeName.equals("disconnect")) {
    		...
    		}else if(nodeName.equals("loadData")) {
    		...
    		}else if(nodeName.equals("recordData")) {
    		...
    		}else if(nodeName.equals("writeDataToFile")) {

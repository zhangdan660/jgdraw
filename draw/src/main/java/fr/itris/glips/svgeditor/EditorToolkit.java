...
public class EditorToolkit {
    ...
    /**
     * the vml  file extension
     */
    public static final String VML_FILE_EXTENSION=".vml";
    ...
    static {
		...
		svgElementLabels.put("ellipse", ResourcesManager.bundle.getString("svgElementName_ellipse"));
		...
		svgElementLabels.put("use", ResourcesManager.bundle.getString("svgElementName_ref"));
		svgElementLabels.put("a", ResourcesManager.bundle.getString("svgElementName_a"));
    ...
    /**
     * computes and returns the value of the given attribute, in pixels, provided that it's a numeric value
     * @param element an element
     * @param attributeName the name of an attribute
     * @return the value of the given attribute, provided that it's a numeric value
     */
    ...
    public static void checkXmlns(Document doc, String prefix, String nameSpace){
        ...
        if(doc!=null && prefix!=null && nameSpace!=null){
            ...
            if(! svgRoot.hasAttributeNS("http://www.w3.org/2000/xmlns/", "xmlns:"+prefix)){
                ...
                svgRoot.setAttributeNS("http://www.w3.org/2000/xmlns/", "xmlns:"+prefix, nameSpace);
            }
        }
    }
    ...
    public static Element getPreviousElementSibling(Element element){
    	...
    	if(element!=null){
        	...
        	for(cur=element.getPreviousSibling();
        		cur!=null; cur=cur.getPreviousSibling()){

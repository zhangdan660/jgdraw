...
import com.nbtoptec.draw.layer.SVGLayerManager;
...
public class SVGHandle {
	...
	private SVGLayerManager layerManager = new SVGLayerManager(this);
	...
	public SVGLayerManager getLayerManager() {
		return layerManager;
	}

	public void setLayerManager(SVGLayerManager layerManager) {
